-- Keep settlement matching inside the function without temporary relations.
-- This is equivalent to the previous greedy matching, and is visible to the
-- SQL linter as well as to Postgres at runtime.
...
begin
  ...
  for debtor_index in 1..coalesce(array_length(debtor_ids, 1), 0) loop
    ...
    values (p_subgroup_id, debtor_ids[debtor_index], debtor_remaining[debtor_index])
